...
rm -rf chuang && git clone https://github.com/lilisore/build-actions chuang > /dev/null 2>&1
if [[ ! -d "chuang/build" ]]; then
  rm -rf chuang && svn co https://github.com/lilisore/build-actions/trunk/build chuang/build > /dev/null 2>&1
